...
//		http.authorizeRequests().anyRequest().permitAll();
		...
		http.authorizeRequests().antMatchers("/project/post").permitAll();
		http.authorizeRequests().antMatchers("/project/get").permitAll();
		http.authorizeRequests().antMatchers("/project/{id}").permitAll();
		http.authorizeRequests().antMatchers("/project/{id}").permitAll();
		
		http.authorizeRequests().antMatchers("/task/post").permitAll();
		http.authorizeRequests().antMatchers("/task/get").permitAll();
		http.authorizeRequests().antMatchers("/task/{id}").permitAll();
		http.authorizeRequests().antMatchers("/task/{id}").permitAll();
		http.authorizeRequests().antMatchers("/task/{id}").permitAll()
