...
import { SidebarData } from './Esidebardata';
            ...
            <NavIcon to='#'>
              ...
              <div className='nav'>
                <div className='nav2'>
                  <ul class="nav-tabs">
                    <li>
                      <Link to="/Econtact" class="link-active">Contact us</Link>
                    </li>
                    <li>
                      <Link to='/Elogin' class="link-active">Logout</Link>
                    </li>
        ...
        <div className='content'>
          ...
          <div className='footer'>
            <p style={{ paddingBottom: '90px' }}>Please read our &nbsp;
              <Link to='/Eprivacy' style={{ color: 'powderblue' }}>privacy policy </Link>
            </p>
          </div>
        </div>
      </div>
