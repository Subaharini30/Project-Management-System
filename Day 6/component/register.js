	...
	return(
		...
		<div className="container">
            ...
            <form className="fregister" style={{position:'relative',top:'-40px'}} onSubmit={handleSubmit}>
				...
				<input value={qual} onChange={(e) => setQual(e.target.value)} type="text" placeholder="qualification" id="qual" name="qual" required/>
                ...
                <div className="form-group">
					...
					<button style={{padding:'20px 210px'}} type="submit">Register</button>
